    ...
    <TableContainer component={Paper}>
      <Table>
        <TableBody>
          ...
          <TableRow>
            <TableCell><strong>Tipo de cliente</strong></TableCell>
            <TableCell>{cliente.tipo_cliente?.nombre}</TableCell>
          </TableRow>

          <TableRow>
            <TableCell><strong>Tipo de persona</strong></TableCell>
            <TableCell>
          ...
          <TableRow>
            <TableCell><strong>Domicilio fiscal</strong></TableCell>
          ...
          <TableRow>
            <TableCell><strong>REPUVE</strong></TableCell>
            <TableCell>{cliente.repve}</TableCell>
          </TableRow>

          <TableRow>
            <TableCell><strong>Plaza</strong></TableCell>
          ...
          <TableRow>
            <TableCell><strong>Tipo de negocio</strong></TableCell>
            <TableCell>{cliente.tipo_negocio}</TableCell>
          </TableRow>

          <TableRow>
            <TableCell><strong>Matriz</strong></TableCell>
            <TableCell>
              {cliente.matriz
          ...
          <TableRow>
            <TableCell><strong>Teléfono alternativo</strong></TableCell>
