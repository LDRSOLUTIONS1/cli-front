...
import ModalDetallePuesto from "../Modals/ModalDetallePuesto";
import PuestosContext from "../../Context/Puestos/PuestosContext";
import EditIcon from "@mui/icons-material/Edit";
import DeleteIcon from "@mui/icons-material/Delete";
import { dateFormatter } from "../../utils/dateFormatter";
import EditPuestos from "../../Moduls/Puestos/EditPuestos";
import AddIcon from "@mui/icons-material/Add";
import { Button } from "@mui/material";
import AddPuestos from "../../Moduls/Puestos/AddPuestos";
...
export default function TablePuestos({ rows = [] }) {
  ...
  const [id_puesto, saveIdPuesto] = useState(null);
