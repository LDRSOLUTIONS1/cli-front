...
import ModalDetalleRegional from "../Modals/ModalDetalleRegional";
import EditRegionales from "../../Moduls/Regionales/EditRegionales";
import AddRegionales from "../../Moduls/Regionales/AddRegionales";
...
export default function TableRegionales({ rows = [] }) {
  ...
  const [id_regional, saveIdRegional] = useState(null);
  ...
  return (
    <>
      ...
      <AddRegionales open={modalAdd} handleClose={handleClickCloseAdd} />
    </>
  );
}
