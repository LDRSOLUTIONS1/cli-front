...
const ModalDetalleDepartamento = ({ open, handleClose, departamento }) => {
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  {dateFormatter(departamento.fecha_registro)}
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell>
                  <EstadoChip estado={departamento.estado} />
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
...
export default ModalDetalleDepartamento;
